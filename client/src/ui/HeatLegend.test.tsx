...
import { RAMP_CLASSIC, RAMP_FLOW, RAMP_IMBALANCE, RAMP_SYNTH, rampCssGradient, rampCssGradientReversed } from '../gl/lut';
...
function mountLegend(colormap: 'flow' | 'inferno' | 'classic', channel: 'sum' | 'bid' | 'ask' | 'imbalance'): HTMLElement {
